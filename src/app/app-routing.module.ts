...
const routes: Routes = [
  ...
  { path: 'qr-restaurant-list', component:  QrRestaurantListComponent, canActivate: [RoleGuard], data: { roles: ["ADMIN", "CSR","MARKETING_DIRECTOR", "MARKETER", "INVOICE_VIEWER", "GMB","ACCOUNTANT", "MENU_EDITOR", "RATE_EDITOR"] } },
