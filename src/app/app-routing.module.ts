...
const routes: Routes = [
  ...
  },
  {
    ...
    canActivate: [RoleGuard],
    data: { roles: ["CSR", "ACCOUNTANT", "ADMIN"] },
  },
  {
    path: "invoices",
    component: InvoiceDashboardComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "ACCOUNTANT", "CSR"] },
  },
  {
    path: "invoices/cycles",
    component: CyclesComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "ACCOUNTANT"] },
  },
  {
    path: "invoices/cycles/:id",
    component: CycleDetailsComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "ACCOUNTANT"] },
  },
  {
    path: "invoices/monthly/:startDate",
    component: InvoiceMonthlyDetailsComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "ACCOUNTANT"] },
  },
  {
    ...
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "ACCOUNTANT", "CSR", "INVOICE_VIEWER"] },
  },
  {
    path: "leads",
    component: LeadDashboardComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "MARKETER", "MARKETING_DIRECTOR", "GMB", "CSR"] },
  },
  {
    path: "my-leads",
    component: MyLeadsComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "MARKETER", "MARKETING_DIRECTOR"] },
  },
  ...
  { path: "profile", component: ProfileComponent },
  {
    ...
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "MENU_EDITOR", "CSR", "ACCOUNTANT", "MARKETER"] },
  },
  {
    path: "restaurants/diagnostics",
    component: MonitoringRestaurantsComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "ACCOUNTANT", "CSR"] },
  },
  {
  ...
  },
  {
    ...
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "CSR"] },
  },
  {
    path: "restaurants/:id/menus",
    component: MenusComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "MENU_EDITOR", "CSR"] },
  },
  {
    path: "restaurants/:id/menu-options",
    component: MenuOptionsComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "MENU_EDITOR", "CSR"] },
  },
  {
    path: "restaurants/:id/invoices",
    component: RestaurantInvoicesComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "ACCOUNTANT", "CSR"] },
  },
  {
  ...
  {
    path: "yelp",
    component: YelpDashboardComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "GMB"] },
  },
  {
    path: "yelp-businesses",
    component: YelpBusinessesComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "GMB"] },
  },
  {
    path: "gmbs",
    component: Gmb2DashboardComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "GMB"] },
  },
  {
  ...
  {
    path: "chains",
    component: ChainsDashboardComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "CSR"] },
  },
  {
  ...
  {
    path: "gmb-accounts",
    component: GmbAccountListComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "GMB"] },
  },
  {
    path: "gmb-businesses",
    component: GmbBizListComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "GMB"] },
  },
  {
    path: "gmb-requests",
    component: GmbRequestListComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "GMB"] },
  },
  {
    path: "gmb-underattacks",
    component: GmbUnderattackListComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "GMB", "CSR", "GMB_SPECIALIST"] },
  },
  {
    path: "gmb-suspended",
    component: GmbSuspendedListComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "GMB", "CSR", "GMB_SPECIALIST"] },
  },
  {
    path: "gmb-losts",
    component: GmbLostListComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "GMB", "CSR", "GMB_SPECIALIST"] },
  },
  {
    path: "gmb-pins",
    component: GmbPinsComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "GMB"] },
  },
  {
    path: "gmb-tasks",
    component: GmbTasksComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "GMB", "CSR", "ACCOUNTANT", "MARKETER_INTERNAL"] },
  },
  {
    path: "gmb-open",
    component: MonitoringGmbOpenComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "GMB"] },
  },
  {
    ...
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "MENU_EDITOR"] },
  },
  {
    path: "sops",
    component: SopDashboardComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "MENU_EDITOR", "CSR", "ACCOUNTANT", "MARKETER"] },
  },
  {
    path: "sops/:id",
    component: SopDetailsComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "MENU_EDITOR", "CSR", "ACCOUNTANT", "MARKETER"] },
  },
  {
  ...
  {
    path: "migration",
    component: AwsMigrationComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN"] },
  },
  {
    path: "postmates-list",
    component: PostmatesListComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "CSR"] },
  },
  {
    path: "invalid-list",
    component: InvalidListComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "CSR", "MARKETER_INTERNAL"] },
  },
  {
    path: "temporarily-disabled",
    component: TemporarilyDisabledComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "CSR", "MARKETER_INTERNAL"] },
  },
  {
    path: "unconfirmed-orders",
    component: MonitoringUnconfirmedOrdersComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "CSR"] },
  },
  {
    path: "fax-problems",
    component: MonitoringFaxComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "CSR"] },
  },
  {
    path: "email-problems",
    component: MonitoringEmailComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "CSR"] },
  },
  {
    path: "monitoring-hours",
    component: MonitoringHoursComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "CSR"] },
  },
  {
    path: "disabled-restaurants",
    component: MonitoringDisabledRestaurantsComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "CSR"] },
  },
  {
  ...
  },
  {
    ...
    component: BannedCustomersComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "GMB", "CSR"] },
  },
  {
    path: "seamless-integration",
    component: SeamlessIntegrationComponent,
    canActivate: [RoleGuard],
    data: { roles: ["ADMIN", "CSR", "MARKETER_INTERNAL"] },
  },
