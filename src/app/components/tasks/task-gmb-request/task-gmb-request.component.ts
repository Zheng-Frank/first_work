...
@Component({
  selector: 'app-task-gmb-request',
  templateUrl: './task-gmb-request.component.html',
  styleUrls: ['./task-gmb-request.component.css']
})
export class TaskGmbRequestComponent implements OnInit, OnChanges {
