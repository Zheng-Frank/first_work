...
const BFields: Field[] = [
  ...
  {name: "Blank_StateIncome", index: 25, length: 12, numeric: true, blank: true},
  ...
  {name: "PayeeCity", index: 33, length: 40},
  {name: "PayeeState", index: 34, length: 2},
  {name: "PayeeZipcode", index: 35, length: 9},

  {name: "Blank", index: 36, length: 1, blank: true},
  // row number (on ALL rows, not just B-record rows!!!) (check out row_numbers_all_match_to_the_end screenshot on trello card 799)
  {name: "RecordSequenceNumber", index: 37, length: 8, numeric: true},
  {name: "Blank", index: 38, length: 36, blank: true},

  {name: "SecondTINNotice", index: 39, length: 1},
  {name: "Blank", index: 40, length: 2, blank: true},
  {name: "TypeOfFiler", index: 41, length: 1},
  {name: "TypeOfPayment", index: 42, length: 1},

  {name: "NumberOfTransactions", index: 43, length: 13, numeric: true},
  {name: "Blank", index: 44, length: 3, blank: true},

  {name: "PSENameAndPhone", index: 45, length: 40},
  {name: "MerchantCategoryCode", index: 46, length: 4},

  {name: "Blank", index: 47, length: 54, blank: true},
  {name: "SpecialDataEntries", index: 48, length: 60, blank: true},
  {name: "StateIncomeTaxWithheld", index: 49, length: 12, numeric: true, blank: true},
  {name: "LocalIncomeTaxWithheld", index: 50, length: 12, numeric: true, blank: true},
  {name: "CFSCCode", index: 51, length: 2},
]
...
const CFields: Field[] = [
  ...
  {name: "NovAmount", index: 17, length: 18, numeric: true},
  {name: "DecAmount", index: 18, length: 18, numeric: true},
  {name: "Blank", index: 19, length: 18, blank: true, numeric: true},
  {name: "Blank", index: 20, length: 18, blank: true, numeric: true},
  {name: "Blank", index: 21, length: 160, blank: true},
  {name: "RecordSequenceNumber", index: 22, length: 8, numeric: true},
  {name: "Blank", index: 23, length: 241, blank: true},
]
