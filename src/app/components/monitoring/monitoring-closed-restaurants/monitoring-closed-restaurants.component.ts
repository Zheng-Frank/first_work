...
@Component({
    selector: 'app-monitoring-closed-restaurants',
    templateUrl: './monitoring-closed-restaurants.component.html',
    styleUrls: ['./monitoring-closed-restaurants.component.css']
})
export class MonitoringClosedRestaurantsComponent implements OnInit {
